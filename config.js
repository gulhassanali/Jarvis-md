...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'Hassan;Brovhi;https://telegra.ph/file/e8ebcd089b0500bd661a6.jpg',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Hassan;ᴡᴀʙᴏᴛ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ:HASSAN-ᴍᴅ;https://telegra.ph/file/e8ebcd089b0500bd661a6.jpg',
  SUDO: process.env.SUDO || '+48699533544',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'Hassan;Brovhi;https://telegra.ph/file/a886614d3f7dfbddbbe76.mp4',
